...
class LongTermMemory():
    ...
    def __init__(self, llm: LLM, memory_retriever: AgentRetriever, now: datetime, verbose: bool, reflection_threshold=float):
        self.llm = llm
        self.now = now
        ...
        # # input keys
        # self.queries_key: str = "queries"
        # self.most_recent_memories_token_key: str = "recent_memories_token"
        self.add_memory_key: str = "add_memory"
        # # output keys
        # self.relevant_memories_key: str = "relevant_memories"
        # self.relevant_memories_simple_key: str = "relevant_memories_simple"
        # self.most_recent_memories_key: str = "most_recent_memories"
